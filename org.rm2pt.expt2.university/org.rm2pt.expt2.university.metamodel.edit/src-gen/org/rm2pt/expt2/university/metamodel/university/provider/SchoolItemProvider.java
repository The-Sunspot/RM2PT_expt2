...
/**
 * This is the item provider adapter for a {@link org.rm2pt.expt2.university.metamodel.university.School} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchoolItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_School_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_School_name_feature", "_UI_School_type"),
						UniversityPackage.Literals.SCHOOL__NAME, true, false, false,
	...
	protected void addSidPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_School_sid_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_School_sid_feature", "_UI_School_type"),
						UniversityPackage.Literals.SCHOOL__SID, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniversityPackage.Literals.SCHOOL__CONTAIN_PERSON);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_School_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(UniversityPackage.Literals.SCHOOL__CONTAIN_PERSON,
				UniversityFactory.eINSTANCE.createTeacher()));
